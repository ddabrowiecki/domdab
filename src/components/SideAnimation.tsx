  ...
  return isOpen ? (
    ...
    <div className="side-wrapper relative">
      <div className="flex items-center justify-center absolute w-[100%] h-[100%]">
        <div className="sm:text-3xl z-40">
          <div className="justify-center whitespace-pre-wrap">
            <div
              className={`job-name text-white ${fireAnimation ? "fade" : ""}`}
              onClick={handleOpen}
            >
              {companyName}
            </div>
      ...
      <div className="box flex flex-start items-center mt-4">
        <div
          className={`side-animation sm:side-animation-desktop sm:hover:cursor-pointer bg-gradient-to-br from-blue-600 via-blue-250 to-indigo-300 ${fireAnimation ? "animate-job" : ""}`}
          onClick={handleOpen}
        >
