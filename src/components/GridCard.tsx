...
const GridCard = ({ name, level, image, emoji, moreInfo }: LanguageDetail) => {
  return (
    <Card className="relative mx-auto w-full max-w-sm pt-0 gap-0 sm:gap-6">
      ...
      />
      <div className="lang-flag hidden sm:h-10 sm:mt-[-15%] z-40 sm:flex sm:justify-center">
        <img className="h-[50%] sm:h-[150%]" src={emoji} />
      </div>
      <CardHeader>
